        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Usuario: <strong> {{ $usuario->username }} </strong> 
                ...
                <div>
                    <button type="button" class="btn btn-success me-2" data-bg-toggle="modal" data-bs-target="#modalAsignarMateria">
            ...
            <form id="formAsignarMateria">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        Todas las materias ya están asignadas a este usuario o no hay sistema.
                    </div>
                    @endif
                </div>
...
<script>
    ...
    function eliminarMateria(asignacionId, nombreMateria){
        Swal.fire({
            title: "¿Eliminar materia?",
            text: `¿Estás seguro de eliminar la materia "${nombreMateria}"?`,
            icon: "warning",
